...
#Plot 4
par(mfrow=c(2,2))
plot(d, dataSelect$Global_active_power, type="l", xlab="", ylab ="Global Active Power")
plot(d, dataSelect$Voltage, type="l", xlab="datetime", ylab ="Voltage")
...
plot(d, dataSelect$Global_reactive_power, type="l", xlab="datetime", ylab ="Global_reactive_power")
dev.copy(png, file = "plot4.png", width = 1280, height = 1280)
dev.off()
